  ...
  dev: {
    ...
    proxyTable: {
      '/common/': {
        ...
        //定义http://192.168.0.118/git/h5_v3.0_develop/common/ == http://192.168.0.118:8080/common/
        pathRewrite: {'^/common' : ''},
        secure: false,
        changeOrigin: true
      },
      '/src/assets/js/': {
        target: 'http://192.168.0.118/git/h5_v3.0_develop/buyers-soupei-V1/src/assets/js/',
        //定义http://192.168.0.118/git/h5_v3.0_develop/buyers-soupei-V1/src/assets/js/ == http://192.168.0.118:8080/src/assets/js
        pathRewrite: {'^/src/assets/js' : ''},
        secure: false,
        changeOrigin: true
      }
    },
