...
export default {
    ...
    mounted: function () {
        this.$nextTick(() => {
            ...
            this.$http.get('http://192.168.0.118:3002/api/v1/client/tenantpart/121049815820565504/121079637691104256/121053092075305984')
                .then((res) => {
            ...
            const makeRequest = async () => {
                const data = await this.$http.get(ENV.jsonApi + 'areas_v2.json');
                if (data) {
                    const moreData = await this.$http.get(ENV.jsonApi + 'sopeiModel.json');
            ...
            if (!this.DONE_SOPEI_MODEL.length) {
                ...
                this.$http.get('http://203.195.242.135:29000/api/sopei/v1.0/factory_info/sp38121728506000000')
                    ...
                    .then((factoryInfo) => {
                        ...
                        this.$http.get(ENV.jsonApi + 'areas_v2.json')
                            .then((res) => {
